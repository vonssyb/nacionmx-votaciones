            ...
            <main className="flex-grow">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        {/* Card 2: Presidency */}
                        {/* Card 2: Presidency */}
                        <div className="relative bg-gray-800 rounded-xl border border-gray-700 hover:border-[#D90F74]/50 transition-all group overflow-hidden h-full min-h-[320px]">
                            {/* Background Image */}
                            <div className="absolute inset-0">
                                <img
                                    src="https://igjedwdxqwkpbgrmtrrq.supabase.co/storage/v1/object/public/evidence/candidates/vonssyb.png"
                                    alt="Vonssyb Symo - Presidente del INE"
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-8">
                                <div className="w-12 h-12 bg-[#D90F74] rounded-lg flex items-center justify-center mb-4 shadow-lg shadow-[#D90F74]/20">
                                    <User className="text-white" size={24} />
                                </div>
                                <h3 className="text-2xl font-bold text-white mb-1">Presidencia del INE</h3>
                                <p className="text-[#D90F74] font-bold text-lg mb-2">Vonssyb Symo</p>
                                <p className="text-gray-300 text-sm mb-4">Liderazgo comprometido con la imparcialidad y el fortalecimiento de nuestras instituciones democráticas.</p>
                            </div>
                        </div>
