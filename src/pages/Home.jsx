        ...
        <div className="min-h-screen bg-gray-900 text-gray-100 flex flex-col">
            ...
            <header className="relative py-20 lg:py-32 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    <img src="https://igjedwdxqwkpbgrmtrrq.supabase.co/storage/v1/object/public/evidence/others/partidos%20politicos/ine4.png" alt="INE Logo" className="h-32 w-auto mx-auto mb-8 drop-shadow-[0_0_15px_rgba(217,15,116,0.5)] animate-fade-in" />
